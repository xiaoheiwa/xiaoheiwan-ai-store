...
export const contentStyles = `
  ...
  [&_h1]:text-foreground [&_h1]:mt-8 [&_h1]:mb-4 [&_h1]:leading-[1.3]
  [&_h1]:pb-2 [&_h1]:border-b-2 [&_h1]:border-accent/30
  
  [&_h2]:text-[1.375rem] [&_h2]:sm:text-[1.5rem] [&_h2]:font-semibold [&_h2]:tracking-tight
  [&_h2]:text-foreground [&_h2]:mt-7 [&_h2]:mb-3 [&_h2]:leading-[1.35]
  [&_h2]:pl-3 [&_h2]:border-l-[3px] [&_h2]:border-accent
  
  [&_h3]:text-[1.125rem] [&_h3]:sm:text-[1.25rem] [&_h3]:font-semibold
  [&_h3]:text-foreground [&_h3]:mt-6 [&_h3]:mb-2 [&_h3]:leading-[1.4]
  
  [&_h4]:text-[1rem] [&_h4]:sm:text-[1.125rem] [&_h4]:font-medium
  [&_h4]:text-foreground [&_h4]:mt-5 [&_h4]:mb-2
  
  /* 段落 - 舒适的阅读体验 */
  [&_p]:text-muted-foreground [&_p]:mb-4 [&_p]:leading-[1.85]
  [&_p:empty]:hidden
  ...
  [&_li]:text-muted-foreground [&_li]:leading-[1.75]
  [&_li_p]:mb-0
  
  /* 引用块 */
  [&_blockquote]:my-5 [&_blockquote]:py-3 [&_blockquote]:px-4 [&_blockquote]:rounded-lg
  ...
  [&_pre]:my-5 [&_pre]:p-4 [&_pre]:rounded-xl
